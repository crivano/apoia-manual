...
* **Otimização de Arquivo:** Reduz o tamanho dos arquivos de áudio antes do processamento, garantindo mais agilidade e economia de custos.
...
2. Na tela "Degravação de Áudio/Vídeo", selecione um arquivo de áudio ou vídeo. É possível arrastar e soltar o arquivo na área indicada ou clicar nela para abrir o seletor de arquivos.
   * **Formatos Suportados:** MP3, MP4, WAV, WMA, OGG, FLAC, entre outros.
   * **Limite:** O tamanho máximo do arquivo é de 100 MB.
3. Após o upload, o sistema iniciará um processo de otimização automática. O arquivo será convertido para um formato de áudio mais leve. Se for um vídeo, apenas o áudio será extraído. Esse processo torna a transcrição mais rápida e eficiente. Opcionalmente, o usuário pode baixar essa versão otimizada do áudio.
4. Clique no botão **"Transcrever"** para iniciar o processamento.
...
Ao final da página, o usuário pode utilizar o **Chat** para fazer perguntas sobre o conteúdo da transcrição ou clicar no botão **PDF** para exportar um relatório completo com todas as informações geradas.
